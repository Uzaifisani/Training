...
document.addEventListener("DOMContentLoaded", function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    productCard = document.querySelector(".product-card[data-id=\"".concat(productId, "\"]"));
                    if (productCard) {
                        productCard.remove();
                    }
                    return [3 /*break*/, 3];
    ...
    (_a = document.getElementById("add-product-btn")) === null || _a === void 0 ? void 0 : _a.addEventListener("click", function () {
